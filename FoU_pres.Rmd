...
* Background <br><br />
  - SCZ is associated with altered cell-type proportions <br><br />
    - Immune alterations (NLR), smoking, medication <br><br />
...
.bitty[
- Morning light strong activator of clock genes and physiological processes 
...
* __Medication-free cases__: significant for neutrophils & CD4T whether adjusted/unadjusted for time-of-blood draw (_p_ <.01)
...
* Background <br><br />
  - SCZ is associated with altered cell-type proportions <br><br />
    - Factors: immune alterations (e.g. NLR), smoking, medication <br><br />
    - Disrupted diurnal (circadian) rhythms 
  ]
...
### Pharmacoepigenetic findings and status  
 .emlarge[EWAS:  _DRD2_, _DRD3_, _HTR2A_, _SLC6A4_, _COMT_] <br> <br />
.bitty[
* Early stages still: <br> <br>
* Variety of methods, tissues assayed, study designs, sample sizes <br> <br /> 
* No uniform identification/reporting of hyper- or hypo-methylation (i.e. _COMT_, _5-HTT_, _HTR2A_)  <br> <br>
...
---
class: left top
###Factors influencing AP concentration 

 .enlarge[Serum values impacted by:
    * Age
    * Sex
    * Smoking
    * Diet
...
.footnote[Hiemke _et al._, Pharmacopsychiatry 2018; Jönsson _et al._, Ther Drug Monit, 2019]

---
## Aims: 

.enlarge[To identify DNAm marks (CpGs) associated with AP drugs with slightly different mechanisms of action:
