...
### Pharmacoepigenetic findings and status  
 .enlarge[EWAS:  _DRD2_, _DRD3_, _HTR2A_, _SLC6A4_, _COMT_] <br> <br />
...
.enlarge[To identify DNAm marks (CpGs) associated with AP drugs with slightly different pharmacological properties:
...
1. Select European SCZ & BPD cases being treated with antipsychotic monotherapy >br> <br> with positive serum values (n=433) <br> <br>
...
.enlarge[**Mod**: DNAm ~ Serum1 + Serum2 + Serum_Lithium + Age + Sex + SmokingScore + <br> <br> Mono + Neu + NK + CD4T + CD8T + Bcells +𝜺] <br> <br> <br />
