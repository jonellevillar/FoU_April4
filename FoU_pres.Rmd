...
.bitty[
**In DNAm studies, either correct for blood collection time - or for cell-types - to reduce epigenetic variation associated with time-of-blood draw and the circadian cycling of white blood cells.** 
]

---
###Project 2
.enlarge[What common and specific DNAm marks are seen following **antipsychotic** drug treatment for psychosis?
* Background - Psychosis
* Symptoms:
     - Hallucinations, delusions, altered sensory perception <br> 
     - **Loss of insight** into their condition <br> 
     - May manifest at different stages for SCZ, BPD <br> <br />
* Treatment:
...
* Mechanism: alterations in multiple neurotransmitter systems & genes but our knowledge is incomplete <br> <br>
 - GABA/Glutamate <br> 
...
1. Pathway analysis  <br> <br>

**To identify common effects**: Plan to compare AP-use vs. non AP-use   <br> <br>
